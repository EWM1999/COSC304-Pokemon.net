...
if ((!filter_input(INPUT_POST, 'userid')) || (!filter_input(INPUT_POST, 'password'))) {
...
session_start();
$productList = null;
if (isset($_SESSION['productList']) && $_SESSION['productList'] != null){
...
$result = sqlsrv_query($con, $sql, array($userid, $password));
if(!$result){
